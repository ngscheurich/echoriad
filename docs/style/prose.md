...
> Conventions for prose — documentation, code comments, commit messages — independent of any one language. For code style see [typescript.md](https://github.com/ngscheurich/echoriad/blob/main/docs/style/typescript.md).
